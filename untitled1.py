...
Original file is located at
    https://colab.research.google.com/drive/16CEnTbujXkYwaiz6_xLqfXaH0IwQpY6p
"""
...
#add second first layer
model.add(Conv2D(32, (5, 5), activation = 'relu'))


#add another plooing layer
model.add(MaxPooling2D(pool_size=(2, 2)))
...
# print 5 with hihest probabilities
i=0
for i in range(5):
